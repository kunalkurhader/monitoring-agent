...
A lightweight, self-hosted **Java monitoring agent** for collecting **system metrics** and **filtered process statistics**, sent securely to Pulsewatch's HTTP API.
...
- Java 17+
- Maven 3.8+
- Pulsewatch base URL and agent API token
...
### ⚙️ Setup Options
- -url -> Pulsewatch base URL
- -token -> Agent API token generated by Pulsewatch
