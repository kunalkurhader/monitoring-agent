...
<main class="mx-auto max-w-screen-2xl px-4 py-6 sm:px-6">
    ...
    <div class="mt-5 space-y-3">
        ...
        @empty
            <section class="rounded-2xl border border-slate-200 bg-white p-10 text-center dark:border-slate-800 dark:bg-slate-900"><h2 class="text-xl font-semibold">No active recommendations</h2><p class="mt-2 text-sm text-slate-500">No Security Group, EC2/RDS exposure, Elastic IP, or public S3 issues were found in the latest synchronized inventory.</p></section>
        @endforelse
    </div>
</main></body></html>
